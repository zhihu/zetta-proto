...
GO_PREFIX_PATH=github.com/zhihu/zetta-proto/pkg
...
GO_OUT_M="Mgoogle/protobuf/any.proto=github.com/gogo/protobuf/types,\
...
function gen() {
    ...
    # protoc -I.:$GOPATH/src/github.com/gogo/protobuf --gofast_out=plugins=grpc,$GO_OUT_M:../pkg/$base_name $1 || ret=$?
